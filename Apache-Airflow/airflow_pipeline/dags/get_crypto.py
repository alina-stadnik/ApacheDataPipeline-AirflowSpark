...
def get_history(ticker, ds=None, ds_nodash=None):
        file_path = f"datalake/crypto/{ticker}//{ticker}_{ds_nodash}.csv"
        ...
        sleep(10) # a cada execução de tarefa o programa espera 10 seg para executar a próxima


# goal: esse mercado funciona todos os dias da semana, ou seja, não precisa especificar a data de execução
